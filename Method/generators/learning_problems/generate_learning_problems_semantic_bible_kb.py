...
lpg = LearningProblemGenerator(kb_path=kb_path, depth=4, num_rand_samples=100, max_num_probs_per_length=100, max_ref_child_length=5, refinement_expressivity=0.1, min_num_pos_examples=1, max_num_pos_examples=723)
