...
if final:
    ...
    record_runtime = True
    save_model = True
experiment.train_all_nets(Models, data_train, data_test, epochs=200, clp_batch_size=256, tc_batch_size=512, kf_n_splits=10, cross_validate=cross_validate, test=test, save_model = save_model, include_embedding_loss=True, optimizer = 'Adam', tc_label_smoothing=0.9, record_runtime=record_runtime)
